...
export const en: Dictionary = {
  ...
  settings: {
    ...
    publish: {
      ...
      lightThemeDesc: "Theme used when visitors switch to light mode on the published site.",
      darkTheme: "Dark theme",
      darkThemeDesc: "Theme used when visitors switch to dark mode on the published site.",
      publish: "Publish",
      preview: "Preview",
      openDir: "Open output",
