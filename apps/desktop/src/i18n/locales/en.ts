...
export const en: Dictionary = {
  ...
  ai: {
    ...
    attachActive: "Toggle current note",
    ...
    settings: {
      ...
      attachActive: "Attach current note by default",
      attachActiveDesc: "Include the open note in each prompt unless removed from chips.",
