...
const STATIC_ENTRIES: StaticEntry[] = [
  ...
  { id: "editor.firstLineIndentMarkdown", section: "editor", titleKey: "settings.editor.firstLineIndentMarkdown", descKey: "settings.editor.firstLineIndentMarkdownDesc" },
  { id: "editor.firstLineIndentPlaintext", section: "editor", titleKey: "settings.editor.firstLineIndentPlaintext", descKey: "settings.editor.firstLineIndentPlaintextDesc" },
