...
const en: Dictionary = {
  ...
  library: {
    ...
    openHint: "Open a Pure Writer folder to browse books, volumes, and chapters.",
    newArticle: "New",
    newChapter: "New",
    save: "Save",
    ...
    bookOpened: "{{name}} · {{count}} chapters",
    saved: "Saved",
    noBook: "No book",
    folders: "Folders",
...
const zhCN: Dictionary = {
  ...
  library: {
    ...
    openLibrary: "打开文库",
    pickTitle: "打开纯纯写作文库",
    openHint: "打开一个纯纯写作文件夹后，即可浏览书、卷与章。",
    newArticle: "新建",
    newChapter: "新建",
    save: "保存",
