...
const en: Dictionary = {
  ...
  editor: {
    ...
    openArticleHint: "Open an article from the sidebar to start writing.",
    copy: "Copy",
    cut: "Cut",
    paste: "Paste",
    ...
    formatTextDesc: "Clean up the current plain-text article with the selected rules.",
    applyFormat: "Format now",
    formatCollapseBlankLines: "Remove extra blank lines",
    formatCollapseBlankLinesDesc: "Keep at most one blank line in a row.",
    formatIndentParagraphs: "Indent paragraphs",
    formatIndentParagraphsDesc: "Add two ideographic spaces to each paragraph start.",
    formatSeparateParagraphs: "Add paragraph spacing",
    formatSeparateParagraphsDesc: "Separate paragraph blocks with one blank line.",
    formatTrimExtraSpaces: "Remove extra spaces",
    formatTrimExtraSpacesDesc: "Trim lines and collapse repeated spaces.",
    formatCjkSpacing: "Space CJK and Latin text",
    formatCjkSpacingDesc: "Add spaces between Chinese, Japanese, Korean and Latin text or numbers.",
  },
  wordCount: {
    label: "{{count}} chars",
  ...
  settings: {
    ...
    shortcuts: {
      ...
      close: "Close article",
      closeHint: "Save and close the current article",
      quit: "Quit",
      quitHint: "Save and quit the app",
...
const zhCN: Dictionary = {
  ...
  editor: {
    ...
    typewriter: "打字机模式",
    formatText: "格式化文本",
    formatTextDesc: "按所选规则整理当前纯文本文章。",
    applyFormat: "一键格式化",
    formatCollapseBlankLines: "删除多余空行",
    formatCollapseBlankLinesDesc: "连续空行最多保留一行。",
    formatIndentParagraphs: "首行缩进",
    formatIndentParagraphsDesc: "为每个段落开头添加两个全角空格。",
    formatSeparateParagraphs: "段落之间添加空行",
    formatSeparateParagraphsDesc: "在段落块之间统一添加一个空行。",
    formatTrimExtraSpaces: "删除多余空格",
    formatTrimExtraSpacesDesc: "清理行首尾并合并连续空格。",
    formatCjkSpacing: "中英文之间添加空格",
    formatCjkSpacingDesc: "在中日韩文字与英文或数字之间添加空格。",
  },
  wordCount: {
    label: "{{count}} 字",
    panelTitle: "字数统计",
