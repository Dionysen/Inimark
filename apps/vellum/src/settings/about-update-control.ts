import { closeIcon, createButton, createIconButton } from "@dionysen/ui";
...
/** About-page software update control: check, download, install, and cancel. */
export function mountAboutUpdateControl(): AboutUpdateControl {
  ...
  const render = (): void => {
    ...
    if (state === "downloading") {
      ...
      cancelBtn.className = "inimark-control inimark-icon-btn inimark-about-update-cancel";
